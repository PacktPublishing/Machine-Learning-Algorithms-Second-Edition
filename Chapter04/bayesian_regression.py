...
if __name__ == '__main__':
    ...
    # Create a Bayesian ridge regressor instance
    ...
    print('Score %.3f' % br.score(X_test, Y_test))

    # CV score
    scores = cross_val_score(br, boston.data, boston.target, cv=7, scoring='neg_mean_squared_error')
    ...
    ev_scores = cross_val_score(br, boston.data, boston.target, cv=10, scoring='explained_variance')
